...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    mysqli_query($conn, "UPDATE siswa SET absen='$absen', nama_siswa='$nama_siswa' where id_siswa='$id_siswa'");
...
<body>
    ...
    <main>
        ...
        <div class="data">
            ...
            include 'koneksi.php';
            $id_siswa = $_GET['id'];
            $siakad = mysqli_query($conn, "SELECT * FROM siswa WHERE id_siswa='$id_siswa'");
            while ($d = mysqli_fetch_array($siakad)) {
                ...
                <form method="post" action="edit_siswa.php">
                    ...
                    <button type="submit" name="id_siswa" value="<?php echo $d['id_siswa']; ?>">Simpan Perubahan</button>
                </form>
                <?php
            }
            ?>
